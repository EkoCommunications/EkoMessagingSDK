...
typedef void (^EkoPermissionCompletion)(BOOL hasPermission);
 ...
 */
- (void)hasPermission:(EkoPermission)permission completion:(nonnull EkoPermissionCompletion)completion ;
 ...
 */
- (void)hasPermission:(EkoPermission)permission forChannel:(nonnull NSString *)channelId completion:(nonnull EkoPermissionCompletion)completion;
...
/**
 ...
 @return: True if permission is granted else returns False
 */
- (void)hasPermission:(EkoPermission)permission forCommunity:(nonnull NSString *)communityId completion:(nonnull EkoPermissionCompletion)completion;
