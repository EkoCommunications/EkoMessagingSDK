 ...
 */
typedef NS_ENUM(NSInteger, EkoPermission) {
    EkoPermissionMuteChannel,
    EkoPermissionCloseChannel,
    EkoPermissionEditChannel,
    EkoPermissionEditChannelRateLimit,
    // Message
    EkoPermissionEditMessage,
    EkoPermissionDeleteMessage,
    // Channel user
    EkoPermissionBanChannelUser,
    EkoPermissionMuteChannelUser,
    EkoPermissionAddChannelUser,
    EkoPermissionRemoveChannelUser,
    EkoPermissionEditChannelUser,
    // User
    EkoPermissionBanUser,
    EkoPermissionEditUser,
    EkoPermissionAssignUserRole,
    // Feed
    EkoPermissionEditUserFeedPost,
    EkoPermissionDeleteUserFeedPost,
    EkoPermissionEditUserFeedComment,
    EkoPermissionDeleteUserFeedComment,
    // Community User
    EkoPermissionAddCommunityUser,
    EkoPermissionRemoveCommunityUser,
    EkoPermissionEditCommunityUser,
    EkoPermissionBanCommunityUser,
    EkoPermissionMuteCommunityUser,
    // Community
    EkoPermissionEditCommunity,
    EkoPermissionDeleteCommunity,
    EkoPermissionEditCommunityPost,
    EkoPermissionDeleteCommunityPost,
    EkoPermissionPinCommunityPost,
    EkoPermissionEditCommunityComment,
    EkoPermissionDeleteCommunityComment
};

typedef NS_ENUM(NSUInteger, EkoChannelMembershipFilter) {
