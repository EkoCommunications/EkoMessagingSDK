...
#ifndef EKOCHAT_SWIFT_H
#define EKOCHAT_SWIFT_H
...
SWIFT_CLASS("_TtC7EkoChat24EkoCommunityChannelQuery")
@interface EkoCommunityChannelQuery : EkoChannelQuery
- (nonnull instancetype)initWithBuilder:(EkoCommunityChannelQueryBuilder * _Nonnull)builder client:(EkoClient * _Nonnull)client OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC7EkoChat31EkoCommunityChannelQueryBuilder")
@interface EkoCommunityChannelQueryBuilder : NSObject
- (nonnull instancetype)initWithFilter:(EkoChannelQueryFilter)filter includingTags:(NSArray<NSString *> * _Nonnull)includingTags excludingTags:(NSArray<NSString *> * _Nonnull)excludingTags includeDeleted:(BOOL)includeDeleted OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
- (void)uploadWithFiles:(NSArray<UploadableFile *> * _Nonnull)files params:(NSDictionary<NSString *, id> * _Nullable)params endpoint:(NSString * _Nonnull)endpoint accessToken:(NSString * _Nonnull)accessToken progressHandler:(void (^ _Nullable)(double))progressHandler completion:(void (^ _Nonnull)(NSDictionary<NSString *, id> * _Nullable, NSError * _Nullable))completion;
/// Attaches a new progress handler for particular uploads. If there is any previous
/// progress handler for this upload, it gets replaced.
- (void)attachProgressHandlerToUploadWithUploadId:(NSString * _Nonnull)uploadId handler:(void (^ _Nonnull)(double))handler;
@end

@class EkoLiveChannelQueryBuilder;

SWIFT_CLASS("_TtC7EkoChat19EkoLiveChannelQuery")
@interface EkoLiveChannelQuery : EkoChannelQuery
- (nonnull instancetype)initWithBuilder:(EkoLiveChannelQueryBuilder * _Nonnull)builder client:(EkoClient * _Nonnull)client OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC7EkoChat26EkoLiveChannelQueryBuilder")
@interface EkoLiveChannelQueryBuilder : NSObject
- (nonnull instancetype)initWithIncludingTags:(NSArray<NSString *> * _Nonnull)includingTags excludingTags:(NSArray<NSString *> * _Nonnull)excludingTags includeDeleted:(BOOL)includeDeleted OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// \endcode
SWIFT_CLASS("_TtC7EkoChat16SocketRawAckView")
...
///
/// \endcode
SWIFT_CLASS("_TtC7EkoChat13SocketRawView")
