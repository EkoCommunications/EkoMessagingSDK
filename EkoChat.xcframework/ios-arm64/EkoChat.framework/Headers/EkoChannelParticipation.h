 ...
 */
- (nonnull EkoCollection<EkoChannelMembership *> *)membershipsForFilter:(EkoChannelMembershipFilter)filter sortBy:(EkoSortBy)sortBy roles:(NSArray<NSString *> *)roles;
